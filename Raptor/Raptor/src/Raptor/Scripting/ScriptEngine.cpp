...
namespace Raptor {
	...
	void ScriptEngine::InitMono()
	{
		...
		/////////////////////////////////
		s_Data->CoreAssembly = LoadCSharpAssembly("resources/scripts/Raptor-ScriptCore.dll");
		PrintAssemblyTypes(s_Data->CoreAssembly);

		////////////////////////////////
		MonoImage* assemblyImage = mono_assembly_get_image(s_Data->CoreAssembly);
		MonoClass* monoClass = mono_class_from_name(assemblyImage, "Raptor", "Main");

		MonoObject* instance = mono_object_new(s_Data->AppDomain,monoClass);
		mono_runtime_object_init(instance);

		MonoMethod* printMesageFunc = mono_class_get_method_from_name(monoClass, "PrintMessage", 0);
		mono_runtime_invoke(printMesageFunc, instance, nullptr, nullptr);
		...
		MonoMethod* printCustomMesageFunc = mono_class_get_method_from_name(monoClass, "PrintCustomMessage", 1);
		mono_runtime_invoke(printCustomMesageFunc, instance, &stringParam, nullptr);
	}
